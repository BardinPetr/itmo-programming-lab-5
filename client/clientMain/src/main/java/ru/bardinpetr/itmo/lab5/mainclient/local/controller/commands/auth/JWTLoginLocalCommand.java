...
public class JWTLoginLocalCommand extends LoginLocalCommand<JWTAuthenticationCredentials> {
    public JWTLoginLocalCommand(APIClientConnector api, UIReceiver ui, ICredentialsStorage<JWTAuthenticationCredentials> credentialsStorage) {
