...
public class JWTLoginLocalCommand extends LoginLocalCommand<StoredJWTCredentials> {
    public JWTLoginLocalCommand(APIClientConnector api, UIReceiver ui, ICredentialsStorage<StoredJWTCredentials> credentialsStorage) {
