...
public class GUITexts_ru extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"bottomPanel.label1.text", "Работникис"},
                ...
                {"EnumPresenter.value.commercial.text", "Коммерческое"},
                {"EnumPresenter.value.public.text", "ПАО"},
                {"EnumPresenter.value.private_limited_company.text", "ООО"},
                {"EnumPresenter.value.open_joint_stock_company.text", "ОАО"},
