...
public class GUITexts_ru extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][]{
                ...
                {"ScriptPanel.executeScriptButton.process.text", "Выполнение скрипта..."},
                {"AddFrame.input.error.text", "Ошибка ввода"},
                {"OrgUpdateFrameZ.title", "Обновление организации"},
                {"OrgUpdateFrameZ.addOrgError.text", "Ошибка организации обновления"},
                {"OrgUpdateFrameZ.updateError.text", "Не удалось обновить организацию"},
                ...
                {"MainFrame.scriptChooseText.description", "Скрипты (*.zb)"},
                ...
                {"MainFrame.canNotAddMsg.text", "Не удалось добавить рабочего"},
                ...
                {"bottomPanel.label1.text", "Работники"},
                {"bottomPanel.label2.text", "Дата инициализации"},
                {"bottomPanel.label4.text", "Количество"},
                ...
                {"OrgAddFrame.addOrgButton.text", "Создать"},
                {"OrgUpdateFrameZ.addOrgButton.text", "обновлять"},
                {"OrgAddFrame.orgrAddCancelButton.text", "Отмена"},
                {"OrganizationShowPanel.clearOrgButton.text", "Очистить"},
                {"OrganizationShowPanel.openAddOrgPlane.text", "Создать"},
                {"OrgUpdateFrame.updateOrgButton.text", "обновлять"},
                {"OrgUpdateFrame.orgUpdateCancelButton.text", "Отмена"},
                {"userInfo.workersCountText.text", "Владеет рабочими:"},
                ...
                {"WorkerAddFrame.addWorkerButton.text", "Создать"},
                ...
                {"OrganizationHeaderPanel.idLabel.text", "Идентификатор организации"},
                ...
                {"EnumPresenter.value.commercial.text", "Торговое"},
                {"EnumPresenter.value.public.text", "Публичное акционерное общество"},
                {"EnumPresenter.value.private_limited_company.text", "С ограниченной ответственностью"},
                {"EnumPresenter.value.open_joint_stock_company.text", "Открытое акционерное общество"},
                {"WorkerShowPanel.openAddWorkerPlane.text", "Создать"},
                {"WorkerShowPanel.clearWorkerButton.text", "Очистить"},
                ...
                {"OrganizationShowPanel.openAddWorkerPlane.text", "Создать"},
                ...
                {"OrganizationTable.deleteError.text", "Не удалось удалить"},
                ...
                {"ScriptInvoker.help.text", "Бог поможет"}
        };
    }
}