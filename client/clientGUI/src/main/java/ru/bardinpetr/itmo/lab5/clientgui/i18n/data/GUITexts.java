...
public class GUITexts extends ListResourceBundle {
    ...
    protected Object[][] getContents() {
        return new Object[][] {
            ...
            {"WorkerInfoPanel.workerSalary.notInRange.text", "value must be greater than zero"},
            ...
            {"WorkerInfoPanel.position.cleaner.text", "cleaner"},
            {"WorkerInfoPanel.position.manager_of_cleaning.text", "manager of cleaning"},
            {"WorkerInfoPanel.position.engineer.text", "engineer"},
            {"WorkerInfoPanel.position.lead_developer.text", "lead developer"},
            {"WorkerInfoPanel.position.head_of_department.text", "head of department"},
